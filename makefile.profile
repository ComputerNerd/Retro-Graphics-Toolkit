...
CFLAGS=-march=native -pg -ggdb -flto -fuse-linker-plugin -I/usr/include/fltk/ -IautogeneratedBindings/ -I. -Ikens/ -c -Wall -Wextra -Wdouble-promotion -O3 -pipe -march=native
...
OBJECTS=project.o main.o callbacks_palette.o callback_tiles.o class_global.o quant.o tilemap.o color_convert.o \
	...
	nespal.o callbacklevel.o filereader.o luaconfig.o lua_zlib.o metasprites.o callbacklua.o dub/dub.o $(BINDINGS:.cpp=.o) cbHelper.o
