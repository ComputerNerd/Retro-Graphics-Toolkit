...
CFLAGS=-march=native -I/usr/include/fltk-1/ -s -Ikens/ -c -Wall -Wextra -Wdouble-promotion -funroll-loops -funswitch-loops -O3 -pipe -march=native -fomit-frame-pointer
LDFLAGS=
