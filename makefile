...
CFLAGS=-march=native -flto -fuse-linker-plugin -I/usr/include/fltk/ -IautogeneratedBindings/ -I. -Ilua/src -s -Ikens/ -c -O3 -pipe -march=native -fomit-frame-pointer -Iluaposix
...
BINDINGS=$(wildcard autogeneratedBindings/*.cpp) $(wildcard luaposix/ext/posix/*.cpp) $(wildcard luaposix/ext/posix/sys/*.cpp)
OBJECTS=project.o main.o callbacks_palette.o callback_tiles.o class_global.o quant.o tilemap.o color_convert.o \
	...
	luaposix/_helpers.o luaposix/strlcpy.o
