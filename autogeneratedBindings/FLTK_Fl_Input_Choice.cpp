...
/** Fl_Boxtype Fl_Lua_Input_Choice::down_box() const
...
/** Fl_Color Fl_Lua_Input_Choice::textcolor() const
...
/** Fl_Font Fl_Lua_Input_Choice::textfont() const
...
/** Fl_Fontsize Fl_Lua_Input_Choice::textsize() const
 ...
 * inc/Fl_Group.h:99
 */
static int Fl_Lua_Input_Choice_insert(lua_State *L) {
  try {
    Fl_Lua_Input_Choice *self = *((Fl_Lua_Input_Choice **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Input_Choice"));
...
static const struct luaL_Reg Fl_Lua_Input_Choice_member_methods[] = {
  ...
  { "insert"       , Fl_Lua_Input_Choice_insert },
