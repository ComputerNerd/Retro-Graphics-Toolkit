 ...
 *
 * Bindings for class Fl_Lua_Progress
 *
...
#include "cbHelper.h"
class Fl_Lua_Progress:public Fl_Progress{
 ...
 * 
 */
static int Fl_Lua_Progress__Fl_Lua_Progress(lua_State *L) {
  try {
    DubUserdata *userdata = ((DubUserdata*)dub::checksdata_d(L, 1, "FLTK.Fl_Lua_Progress"));
    if (userdata->gc) {
      Fl_Lua_Progress *self = (Fl_Lua_Progress *)userdata->ptr;
 ...
 * 
 */
static int Fl_Lua_Progress__cast_(lua_State *L) {

  Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata_n(L, 1, "FLTK.Fl_Lua_Progress"));
...
/** Fl_Lua_Progress::Fl_Lua_Progress(int x, int y, int w, int h, const char *l=0)
 * inc/Fl_Lua_Progress.h:50
 */
static int Fl_Lua_Progress_Fl_Lua_Progress(lua_State *L) {
  try {
    ...
    if (top__ >= 5) {
      ...
      Fl_Lua_Progress *retval__ = new Fl_Lua_Progress(x, y, w, h, l);
	retval__->ci.L=L;
	retval__->ci.cb=0;
      dub::pushudata(L, retval__, "FLTK.Fl_Lua_Progress", true);
      return 1;
    } else {
      int x = dub::checkinteger(L, 1);
      int y = dub::checkinteger(L, 2);
      int w = dub::checkinteger(L, 3);
      int h = dub::checkinteger(L, 4);
      Fl_Lua_Progress *retval__ = new Fl_Lua_Progress(x, y, w, h);
	retval__->ci.L=L;
	retval__->ci.cb=0;
      dub::pushudata(L, retval__, "FLTK.Fl_Lua_Progress", true);
      return 1;
...
/** void Fl_Lua_Progress::maximum(float v)
 * inc/Fl_Lua_Progress.h:53
 */
static int Fl_Lua_Progress_maximum(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
    int top__ = lua_gettop(L);
    if (top__ >= 2) {
      float v = dub::checknumber(L, 2);
      self->maximum(v);
      return 0;
    } else {
...
/** void Fl_Lua_Progress::minimum(float v)
 * inc/Fl_Lua_Progress.h:58
 */
static int Fl_Lua_Progress_minimum(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
    int top__ = lua_gettop(L);
    if (top__ >= 2) {
...
/** void Fl_Lua_Progress::value(float v)
 * inc/Fl_Lua_Progress.h:63
 */
static int Fl_Lua_Progress_value(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
    int top__ = lua_gettop(L);
    if (top__ >= 2) {
 ...
 * inc/Fl_Widget.h:236
 */
static int Fl_Lua_Progress_handle(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
 ...
 * inc/Fl_Widget.h:243
 */
static int Fl_Lua_Progress_parent(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
    int top__ = lua_gettop(L);
    if (top__ >= 2) {
 ...
 * inc/Fl_Widget.h:263
 */
static int Fl_Lua_Progress_type(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
    int top__ = lua_gettop(L);
    if (top__ >= 2) {
 ...
 * inc/Fl_Widget.h:273
 */
static int Fl_Lua_Progress_x(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
 ...
 * inc/Fl_Widget.h:278
 */
static int Fl_Lua_Progress_y(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
 ...
 * inc/Fl_Widget.h:283
 */
static int Fl_Lua_Progress_w(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
 ...
 * inc/Fl_Widget.h:288
 */
static int Fl_Lua_Progress_h(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
 ...
 * inc/Fl_Widget.h:309
 */
static int Fl_Lua_Progress_resize(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
 ...
 * inc/Fl_Widget.h:312
 */
static int Fl_Lua_Progress_damage_resize(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
 ...
 * inc/Fl_Widget.h:321
 */
static int Fl_Lua_Progress_position(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
    int X = dub::checkinteger(L, 2);
    int Y = dub::checkinteger(L, 3);
 ...
 * inc/Fl_Widget.h:330
 */
static int Fl_Lua_Progress_size(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
 ...
 * inc/Fl_Widget.h:337
 */
static int Fl_Lua_Progress_align(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
    int top__ = lua_gettop(L);
    if (top__ >= 2) {
 ...
 * inc/Fl_Widget.h:352
 */
static int Fl_Lua_Progress_box(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
    int top__ = lua_gettop(L);
    if (top__ >= 2) {
 ...
 * inc/Fl_Widget.h:367
 */
static int Fl_Lua_Progress_color(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
    int top__ = lua_gettop(L);
    if (top__ >= 3) {
 ...
 * inc/Fl_Widget.h:385
 */
static int Fl_Lua_Progress_selection_color(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
    int top__ = lua_gettop(L);
    if (top__ >= 2) {
 ...
 * inc/Fl_Widget.h:410
 */
static int Fl_Lua_Progress_label(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
    int top__ = lua_gettop(L);
    if (top__ >= 3) {
 ...
 * inc/Fl_Widget.h:434
 */
static int Fl_Lua_Progress_copy_label(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
 ...
 * inc/Fl_Widget.h:445
 */
static int Fl_Lua_Progress_labeltype(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
    int top__ = lua_gettop(L);
    if (top__ >= 2) {
 ...
 * inc/Fl_Widget.h:461
 */
static int Fl_Lua_Progress_labelcolor(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
    int top__ = lua_gettop(L);
    if (top__ >= 2) {
 ...
 * inc/Fl_Widget.h:476
 */
static int Fl_Lua_Progress_labelfont(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
    int top__ = lua_gettop(L);
    if (top__ >= 2) {
 ...
 * inc/Fl_Widget.h:491
 */
static int Fl_Lua_Progress_labelsize(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
    int top__ = lua_gettop(L);
    if (top__ >= 2) {
 ...
 * inc/Fl_Widget.h:503
 */
static int Fl_Lua_Progress_image(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
    int top__ = lua_gettop(L);
    if (top__ >= 2) {
 ...
 * inc/Fl_Widget.h:522
 */
static int Fl_Lua_Progress_deimage(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
    int top__ = lua_gettop(L);
    if (top__ >= 2) {
 ...
 * inc/Fl_Widget.h:541
 */
static int Fl_Lua_Progress_tooltip(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
    int top__ = lua_gettop(L);
    if (top__ >= 2) {
 ...
 * inc/Fl_Widget.h:544
 */
static int Fl_Lua_Progress_copy_tooltip(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
    const char *text = dub::checkstring(L, 2);
 ...
 * inc/Fl_Widget.h:550
 */
static int Fl_Lua_Progress_callback(lua_State *L) {
	try {
		Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
		int top__ = lua_gettop(L);
		if (top__ >= 3) {
 ...
 * inc/Fl_Widget.h:582
 */
static int Fl_Lua_Progress_user_data(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
    int top__ = lua_gettop(L);
    if (top__ >= 2) {
 ...
 * inc/Fl_Widget.h:592
 */
static int Fl_Lua_Progress_argument(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
    int top__ = lua_gettop(L);
    if (top__ >= 2) {
 ...
 * inc/Fl_Widget.h:608
 */
static int Fl_Lua_Progress_when(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
    int top__ = lua_gettop(L);
    if (top__ >= 2) {
 ...
 * inc/Fl_Widget.h:647
 */
static int Fl_Lua_Progress_visible(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
 ...
 * inc/Fl_Widget.h:653
 */
static int Fl_Lua_Progress_visible_r(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
 ...
 * inc/Fl_Widget.h:672
 */
static int Fl_Lua_Progress_show(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
    self->show();
    return 0;
 ...
 * inc/Fl_Widget.h:677
 */
static int Fl_Lua_Progress_hide(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
    self->hide();
    return 0;
 ...
 * inc/Fl_Widget.h:683
 */
static int Fl_Lua_Progress_set_visible(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
    self->set_visible();
    return 0;
 ...
 * inc/Fl_Widget.h:689
 */
static int Fl_Lua_Progress_clear_visible(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
    self->clear_visible();
    return 0;
 ...
 * inc/Fl_Widget.h:695
 */
static int Fl_Lua_Progress_active(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
 ...
 * inc/Fl_Widget.h:701
 */
static int Fl_Lua_Progress_active_r(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
 ...
 * inc/Fl_Widget.h:708
 */
static int Fl_Lua_Progress_activate(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
    self->activate();
    return 0;
 ...
 * inc/Fl_Widget.h:724
 */
static int Fl_Lua_Progress_deactivate(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
    self->deactivate();
    return 0;
 ...
 * inc/Fl_Widget.h:734
 */
static int Fl_Lua_Progress_output(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
 ...
 * inc/Fl_Widget.h:739
 */
static int Fl_Lua_Progress_set_output(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
    self->set_output();
    return 0;
 ...
 * inc/Fl_Widget.h:744
 */
static int Fl_Lua_Progress_clear_output(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
    self->clear_output();
    return 0;
 ...
 * inc/Fl_Widget.h:751
 */
static int Fl_Lua_Progress_takesevents(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
 ...
 * inc/Fl_Widget.h:768
 */
static int Fl_Lua_Progress_changed(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
 ...
 * inc/Fl_Widget.h:773
 */
static int Fl_Lua_Progress_set_changed(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
    self->set_changed();
    return 0;
 ...
 * inc/Fl_Widget.h:778
 */
static int Fl_Lua_Progress_clear_changed(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
    self->clear_changed();
    return 0;
...
static int Fl_Lua_Progress_clear_active(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
    self->clear_active();
    return 0;
 ...
 * inc/Fl_Widget.h:790
 */
static int Fl_Lua_Progress_set_active(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
    self->set_active();
    return 0;
 ...
 * inc/Fl_Widget.h:799
 */
static int Fl_Lua_Progress_take_focus(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
 ...
 * inc/Fl_Widget.h:807
 */
static int Fl_Lua_Progress_set_visible_focus(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
 ...
 * inc/Fl_Widget.h:813
 */
static int Fl_Lua_Progress_clear_visible_focus(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
 ...
 * inc/Fl_Widget.h:819
 */
static int Fl_Lua_Progress_visible_focus(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
    int top__ = lua_gettop(L);
    if (top__ >= 2) {
 ...
 * inc/Fl_Widget.h:840
 */
static int Fl_Lua_Progress_do_callback(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
    int top__ = lua_gettop(L);
    if (top__ >= 3) {
 ...
 * inc/Fl_Widget.h:855
 */
static int Fl_Lua_Progress_test_shortcut(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
    int top__ = lua_gettop(L);
    if (top__ >= 3) {
      ...
      lua_pushnumber(L, Fl_Lua_Progress::test_shortcut(p1, require_alt));
      return 1;
    } else if (top__ >= 2) {
      const char *p1 = dub::checkstring(L, 2);
      lua_pushnumber(L, Fl_Lua_Progress::test_shortcut(p1));
      return 1;
    } else {
 ...
 * inc/Fl_Widget.h:861
 */
static int Fl_Lua_Progress__set_fullscreen(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
 ...
 * inc/Fl_Widget.h:862
 */
static int Fl_Lua_Progress__clear_fullscreen(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
 ...
 * inc/Fl_Widget.h:869
 */
static int Fl_Lua_Progress_contains(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
 ...
 * inc/Fl_Widget.h:877
 */
static int Fl_Lua_Progress_inside(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
 ...
 * inc/Fl_Widget.h:882
 */
static int Fl_Lua_Progress_redraw(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
    self->redraw();
    return 0;
 ...
 * inc/Fl_Widget.h:888
 */
static int Fl_Lua_Progress_redraw_label(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
    self->redraw_label();
    return 0;
 ...
 * inc/Fl_Widget.h:896
 */
static int Fl_Lua_Progress_damage(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
    int top__ = lua_gettop(L);
    if (top__ >= 6) {
 ...
 * inc/Fl_Widget.h:910
 */
static int Fl_Lua_Progress_clear_damage(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
    int top__ = lua_gettop(L);
    if (top__ >= 2) {
 ...
 * inc/Fl_Widget.h:927
 */
static int Fl_Lua_Progress_draw_label(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
    int p1 = dub::checkinteger(L, 2);
    int p2 = dub::checkinteger(L, 3);
 ...
 * inc/Fl_Widget.h:936
 */
static int Fl_Lua_Progress_measure_label(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
 ...
 * inc/Fl_Widget.h:938
 */
static int Fl_Lua_Progress_window(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
 ...
 */
#if (FL_MAJOR_VERSION>=1 && FL_MINOR_VERSION>=3 && FL_PATCH_VERSION>=3)
static int Fl_Lua_Progress_top_window(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
 ...
 * inc/Fl_Widget.h:940
 */
static int Fl_Lua_Progress_top_window_offset(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
 ...
 * inc/Fl_Widget.h:965
 */
static int Fl_Lua_Progress_as_group(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
 ...
 * inc/Fl_Widget.h:979
 */
static int Fl_Lua_Progress_as_window(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
 ...
 * inc/Fl_Widget.h:991
 */
static int Fl_Lua_Progress_as_gl_window(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
 ...
 */
#if (FL_MAJOR_VERSION>=1 && FL_MINOR_VERSION>=3 && FL_PATCH_VERSION>=3)
static int Fl_Lua_Progress_use_accents_menu(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
 ...
 */
static int Fl_Lua_Progress_color2(lua_State *L) {
  try {
    Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata(L, 1, "FLTK.Fl_Lua_Progress"));
    int top__ = lua_gettop(L);
    if (top__ >= 2) {
...
// --=============================================== __tostring
static int Fl_Lua_Progress___tostring(lua_State *L) {
  Fl_Lua_Progress *self = *((Fl_Lua_Progress **)dub::checksdata_n(L, 1, "FLTK.Fl_Lua_Progress"));
  lua_pushfstring(L, "FLTK.Fl_Lua_Progress: %p", self);
...
static const struct luaL_Reg Fl_Lua_Progress_member_methods[] = {
  { "__gc"         , Fl_Lua_Progress__Fl_Lua_Progress },
  { "_cast_"       , Fl_Lua_Progress__cast_   },
  { "new"          , Fl_Lua_Progress_Fl_Lua_Progress },
  { "maximum"      , Fl_Lua_Progress_maximum  },
  { "minimum"      , Fl_Lua_Progress_minimum  },
  { "value"        , Fl_Lua_Progress_value    },
  { "handle"       , Fl_Lua_Progress_handle   },
  { "parent"       , Fl_Lua_Progress_parent   },
  { "Type"         , Fl_Lua_Progress_type     },
  { "x"            , Fl_Lua_Progress_x        },
  { "y"            , Fl_Lua_Progress_y        },
  { "w"            , Fl_Lua_Progress_w        },
  { "h"            , Fl_Lua_Progress_h        },
  { "resize"       , Fl_Lua_Progress_resize   },
  { "damage_resize", Fl_Lua_Progress_damage_resize },
  { "position"     , Fl_Lua_Progress_position },
  { "size"         , Fl_Lua_Progress_size     },
  { "align"        , Fl_Lua_Progress_align    },
  { "box"          , Fl_Lua_Progress_box      },
  { "color"        , Fl_Lua_Progress_color    },
  { "selection_color", Fl_Lua_Progress_selection_color },
  { "label"        , Fl_Lua_Progress_label    },
  { "copy_label"   , Fl_Lua_Progress_copy_label },
  { "labeltype"    , Fl_Lua_Progress_labeltype },
  { "labelcolor"   , Fl_Lua_Progress_labelcolor },
  { "labelfont"    , Fl_Lua_Progress_labelfont },
  { "labelsize"    , Fl_Lua_Progress_labelsize },
  { "image"        , Fl_Lua_Progress_image    },
  { "deimage"      , Fl_Lua_Progress_deimage  },
  { "tooltip"      , Fl_Lua_Progress_tooltip  },
  { "copy_tooltip" , Fl_Lua_Progress_copy_tooltip },
  { "callback"     , Fl_Lua_Progress_callback },
  { "user_data"    , Fl_Lua_Progress_user_data },
  { "argument"     , Fl_Lua_Progress_argument },
  { "when"         , Fl_Lua_Progress_when     },
  { "visible"      , Fl_Lua_Progress_visible  },
  { "visible_r"    , Fl_Lua_Progress_visible_r },
  { "show"         , Fl_Lua_Progress_show     },
  { "hide"         , Fl_Lua_Progress_hide     },
  { "set_visible"  , Fl_Lua_Progress_set_visible },
  { "clear_visible", Fl_Lua_Progress_clear_visible },
  { "active"       , Fl_Lua_Progress_active   },
  { "active_r"     , Fl_Lua_Progress_active_r },
  { "activate"     , Fl_Lua_Progress_activate },
  { "deactivate"   , Fl_Lua_Progress_deactivate },
  { "output"       , Fl_Lua_Progress_output   },
  { "set_output"   , Fl_Lua_Progress_set_output },
  { "clear_output" , Fl_Lua_Progress_clear_output },
  { "takesevents"  , Fl_Lua_Progress_takesevents },
  { "changed"      , Fl_Lua_Progress_changed  },
  { "set_changed"  , Fl_Lua_Progress_set_changed },
  { "clear_changed", Fl_Lua_Progress_clear_changed },
#if (FL_MAJOR_VERSION>=1 && FL_MINOR_VERSION>=3 && FL_PATCH_VERSION>=3)
  { "clear_active" , Fl_Lua_Progress_clear_active },
  { "set_active"   , Fl_Lua_Progress_set_active },
#endif
  { "take_focus"   , Fl_Lua_Progress_take_focus },
  { "set_visible_focus", Fl_Lua_Progress_set_visible_focus },
  { "clear_visible_focus", Fl_Lua_Progress_clear_visible_focus },
  { "visible_focus", Fl_Lua_Progress_visible_focus },
  { "do_callback"  , Fl_Lua_Progress_do_callback },
  { "test_shortcut", Fl_Lua_Progress_test_shortcut },
  { "_set_fullscreen", Fl_Lua_Progress__set_fullscreen },
  { "_clear_fullscreen", Fl_Lua_Progress__clear_fullscreen },
  { "contains"     , Fl_Lua_Progress_contains },
  { "inside"       , Fl_Lua_Progress_inside   },
  { "redraw"       , Fl_Lua_Progress_redraw   },
  { "redraw_label" , Fl_Lua_Progress_redraw_label },
  { "damage"       , Fl_Lua_Progress_damage   },
  { "clear_damage" , Fl_Lua_Progress_clear_damage },
  { "draw_label"   , Fl_Lua_Progress_draw_label },
  { "measure_label", Fl_Lua_Progress_measure_label },
  { "window"       , Fl_Lua_Progress_window   },
#if (FL_MAJOR_VERSION>=1 && FL_MINOR_VERSION>=3 && FL_PATCH_VERSION>=3)
  { "top_window"   , Fl_Lua_Progress_top_window },
  { "top_window_offset", Fl_Lua_Progress_top_window_offset },
#endif
  { "as_group"     , Fl_Lua_Progress_as_group },
  { "as_window"    , Fl_Lua_Progress_as_window },
  { "as_gl_window" , Fl_Lua_Progress_as_gl_window },
#if (FL_MAJOR_VERSION>=1 && FL_MINOR_VERSION>=3 && FL_PATCH_VERSION>=3)
  { "use_accents_menu", Fl_Lua_Progress_use_accents_menu },
#endif
  { "color2"       , Fl_Lua_Progress_color2   },
  { "__tostring"   , Fl_Lua_Progress___tostring },
 ...
 int luaopen_FLTK_Fl_Progress(lua_State *L)
{
  ...
  luaL_newmetatable(L, "FLTK.Fl_Lua_Progress");
  // <mt>

  // register member methods
  dub::fregister(L, Fl_Lua_Progress_member_methods);
  // setup meta-table
  dub::setup(L, "FLTK.Fl_Lua_Progress");
  // <mt>
  return 1;
}
