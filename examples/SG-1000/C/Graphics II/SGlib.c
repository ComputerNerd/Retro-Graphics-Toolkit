...
const unsigned char VDPReg_init[8]={
                  0x02, // Mode2
                  0x80,	// 16KB, screen off, VBlank IRQ, sprite 8x8, no zoom
...
unsigned char	VDPReg[2]={0x02, 0x80};
...
void SG_loadTilePatterns (const void *src, uint16_t tilefrom, uint16_t size) {
