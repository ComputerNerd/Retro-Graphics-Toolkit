...
private:
	...
	uint_fast32_t cal_offset_zoom_rgb(uint_fast16_t x, uint_fast16_t y, uint_fast16_t zoom, uint8_t channel, unsigned bpp)const {
...
public:
	...
	void draw_truecolor(uint32_t tile, unsigned x, unsigned y, bool usehflip, bool usevflip, unsigned zoom);
	void draw_tile(int x_off, int y_off, uint32_t tile_draw, unsigned zoom, unsigned pal_row, bool Usehflip, bool Usevflip, bool isSprite = false, bool alpha = false, unsigned useColor = 0)const;
