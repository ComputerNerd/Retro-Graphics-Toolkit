...
static const Fl_Menu_Item menuEditor[]={
	{"File",0, 0, 0, FL_SUBMENU},
		{"Tiles",0, 0, 0, FL_SUBMENU},
			{"Import tiles",0,load_tiles,0},
			{"Open truecolor tiles",0,load_truecolor_tiles,0},
			{"Import tiles (append)",0,load_tiles,(void*)1},
			{"Export tiles",0,save_tiles,0},
		...
		{"Palette",0, 0, 0, FL_SUBMENU},
			{"Import palette",0,loadPalette,0},
			{"Export palette",0, save_palette,0},
			{0},
